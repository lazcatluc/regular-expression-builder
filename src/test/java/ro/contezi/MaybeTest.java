...
public class MaybeTest {
	...
	public void maybeABMatchesEmpty() throws Exception {
		assertThat(maybe("AB").build().matcher("").matches()).isTrue();
	}
	
	@Test
	public void maybeABMatchesAB() throws Exception {
		assertThat(maybe("AB").build().matcher("AB").matches()).isTrue();
	}
	
	@Test
	public void maybeABDoesntMatchAC() throws Exception {
		assertThat(maybe("AB").build().matcher("AC").matches()).isFalse();
	}
}
